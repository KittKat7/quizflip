...
class Flashcard {
  ...
  Flashcard({String? key, String? deck, List<String>? values, String? tags,
  int? confidence}) : _deck = FilterStack(filterStr: deck??''), _values = values??[''],
  _key = key??'', _tags = _validateTags(tags ?? ''), _confidence = (confidence ?? -1);
  ...
  @override
  bool operator ==(Object other) { return other is Flashcard? id == other.id : false; }
}//Flashcard
...
String _validateTagStr(String str) {
  ...
  List<String> lowerList = List<String>.generate(26, (index) => String.fromCharCode(index+a));
  List<String> upperList = List<String>.generate(26, (index) => String.fromCharCode(index+A));
  List<String> specialList = ['_', '-', '.', '#'];
  // List<String> specialList = ['/', '#', '_', '-', '.', '+', '='];
  List<String> permittedChars = numberList+lowerList+upperList+specialList;
