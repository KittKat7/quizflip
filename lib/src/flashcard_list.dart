...
Stream<List<Flashcard>> get filteredCardsStream => filteredCardStreamController.stream;
...
class CardList {
  ...
  static List<Flashcard> get filteredCards => List<Flashcard>.from(_filteredCards);
  ...
  static bool removeCard(Flashcard card) {
    ...
    if (removed) { saveCards(); updateFilteredCards(); }
    return removed;
  }//remove
