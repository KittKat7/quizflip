  ...
  Widget build(BuildContext context) {
    ...
    Widget resetConfidence(Widget child) {
      return LongPressWidget(
        child: child,
        onLongPress: () { practice.setConfidence(-1); setState((){}); });
    }
    ...
    BottomAppBar bottomAppBar = BottomAppBar(
      child: Row(children: [
        ...
        Expanded(child: resetConfidence(IconButton(
          onPressed: () { practice.setConfidence(0); setState((){}); },
          icon: Icon(practice.confidence == 0? Icons.remove_circle: Icons.remove_circle_outline)),)),
        Expanded(child: resetConfidence(IconButton(
          onPressed: () { practice.setConfidence(1); setState((){}); },
          icon: Icon(practice.confidence == 1? Icons.circle : Icons.circle_outlined)),)),
        Expanded(child: resetConfidence(IconButton(
